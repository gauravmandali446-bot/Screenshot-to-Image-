          ...
          {path === '/privacy-policy' && (
            <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
              ...
              <section className="space-y-3 border-t border-gray-100 pt-5">
                ...
                <p>
                  If you have any questions regarding our client-side guarantee or data-handling procedures, please contact us via email at <a href="mailto:support@imagetojpg.org" className="text-blue-600 hover:underline">support@imagetojpg.org</a> or use our <a href="/contact" onClick={(e) => { e.preventDefault(); navigate('/contact'); }} className="text-blue-600 hover:underline">Contact Form</a>.
                </p>
              </section>
            </div>
          )}
          ...
          {(path === '/terms' || path === '/terms-and-conditions') && (
            <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
              <section className="space-y-3">
                ...
                <p>
                  By accessing or using the website at <a href="https://imagetojpg.org" className="text-blue-600 hover:underline">https://imagetojpg.org</a> and its associated local converter tools, you agree to be bound by these Terms and Conditions. If you do not agree, please do not use our local converter service.
                </p>
              </section>
              ...
              <section className="space-y-3 border-t border-gray-100 pt-5">
                ...
                <p>
                  If you require clarification on these Terms and Conditions, please reach out to our team at <a href="mailto:support@imagetojpg.org" className="text-blue-600 hover:underline">support@imagetojpg.org</a>.
                </p>
              </section>
            </div>
          )}
                  ...
                  <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100 space-y-4">
                    ...
                    <div className="space-y-2.5 text-xs text-gray-600">
                      ...
                      <div className="p-3 bg-white rounded-xl border border-gray-200/60 font-mono text-center font-bold text-blue-600 selection:bg-blue-100">
                        <a href="mailto:support@imagetojpg.org">support@imagetojpg.org</a>
                      </div>
                    </div>
                  </div>
